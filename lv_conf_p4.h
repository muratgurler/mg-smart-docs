...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "esp_timer.h"       /*ESP-IDF component-safe tick source*/
...
#define LV_FONT_CUSTOM_DECLARE   LV_FONT_DECLARE(mg_font_10) \
                                 LV_FONT_DECLARE(mg_font_14) \
                                 LV_FONT_DECLARE(mg_font_20) \
                                 LV_FONT_DECLARE(mg_font_pin_84)

/*Always set a default font*/
#define LV_FONT_DEFAULT &mg_font_14
